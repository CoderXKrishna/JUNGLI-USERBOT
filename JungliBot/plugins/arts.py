...
@bot.on(jungli_cmd(pattern="carry (.*)"))
...
@bot.on(jungli_cmd(pattern="sthink (.*)"))
...
@bot.on(jungli_cmd(pattern="sfrog (.*)"))
...
@bot.on(jungli_cmd(pattern="sdead (.*)"))
...
@bot.on(jungli_cmd(pattern="strump (.*)"))
...
@bot.on(jungli_cmd(pattern="schina (.*)"))
...
@bot.on(jungli_cmd(pattern=r"sshit$"))
...
@bot.on(jungli_cmd(pattern=r"elove$"))
...
@bot.on(jungli_cmd(pattern=r"monster$"))
...
@bot.on(jungli_cmd(pattern=r"pig$"))
...
@bot.on(jungli_cmd(pattern=r"gun$"))
...
@bot.on(jungli_cmd(pattern=r"dog$"))
...
@bot.on(jungli_cmd(pattern=r"junglio$"))
@bot.on(sudo_cmd(pattern="junglio$", allow_sudo=True))
async def bluedeviljunglio(junglio):
    if junglio.fwd_from:
        return
    await edit_or_reply(junglio, K)


@bot.on(jungli_cmd(pattern=r"hmf$"))
...
@bot.on(jungli_cmd(pattern=r"couple$"))
...
@bot.on(jungli_cmd(pattern=r"sup$"))
...
@bot.on(jungli_cmd(pattern=r"india$"))
...
@bot.on(jungli_cmd(pattern=r"wc$"))
...
@bot.on(jungli_cmd(pattern=r"snk$"))
...
@bot.on(jungli_cmd(pattern=r"bye$"))
...
@bot.on(jungli_cmd(pattern=r"shitos$"))
...
@bot.on(jungli_cmd(pattern=r"dislike$"))
