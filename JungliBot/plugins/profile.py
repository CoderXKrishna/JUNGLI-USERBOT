...
OFFLINE_TAG = "[ • OFFLINE • ]"
ONLINE_TAG = "[ • ONLINE • ]"
PROFILE_IMAGE = "https://telegra.ph/file/0b9d7bd278272147f1f3c.jpg"
# ===============================================================

@bot.on(jungli_cmd(pattern="offline$", outgoing=True)) 
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
    ...
    urllib.request.urlretrieve(
        "https://telegra.ph/file/0b9d7bd278272147f1f3c.jpg", "donottouch.jpg"
    )
...
@bot.on(jungli_cmd(pattern="online$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
...
@bot.on(jungli_cmd(pattern="pbio (.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(jungli_cmd(pattern="pname (.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(jungli_cmd(pattern="ppic"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(jungli_cmd(outgoing=True, pattern="username (.*)"))
...
@bot.on(jungli_cmd(outgoing=True, pattern="count$"))
...
@bot.on(jungli_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(jungli_cmd(pattern="myusernames$"))
async def _(event):
    if event.fwd_from:
        return
