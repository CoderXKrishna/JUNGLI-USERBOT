...
@bot.on(jungli_cmd(pattern="anilist (.*)"))
...
@bot.on(jungli_cmd(pattern="anime(?: |$)(.*)"))
@bot.on(sudo_cmd(pattern="anime(?: |$)(.*)", allow_sudo=True))
async def nope(hel_):
    jungli = hel_.pattern_match.group(1)
    if not jungli:
        if hel_.is_reply:
    ...
    troll = await bot.inline_query("AniFluidbot", f".anime {(deEmojify(jungli))}")
...
@bot.on(jungli_cmd(pattern="manga(?: |$)(.*)"))
...
async def nope(hel_):
    ...
    troll = await bot.inline_query("AniFluidbot", f".manga {(deEmojify(jungli))}")
...
@bot.on(jungli_cmd(pattern="character(?: |$)(.*)"))
...
async def nope(hel_):
    ...
    troll = await bot.inline_query("AniFluidbot", f".character {(deEmojify(jungli))}")
