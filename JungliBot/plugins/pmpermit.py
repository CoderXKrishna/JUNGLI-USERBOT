...
from . import *
from JungliBot.sql import pmpermit_sql as pm_sql


WARN_PIC = Config.PMPERMIT_PIC or "https://telegra.ph/file/0b9d7bd278272147f1f3c.jpg"
PM_WARNS = {}
PREV_REPLY_MESSAGE = {}
...
HELL_FIRST = (
    "⚠️ 𝐇𝐄𝐋𝐋𝐎, 𝐓𝐇𝐈𝐒 𝐈𝐒 Jυɳɠʅι Aɾαɳƙ Bσƚ 𝐔𝐋𝐓𝐑𝐀 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 𝐒𝐄𝐂𝐔𝐑𝐈𝐓𝐘 𝐏𝐑𝐎𝐓𝐎𝐂𝐎𝐋 ⚠️\n"
    f"\n{CSTM_PMP}\n\n"
    "To start a valid conversation\n\n🔸Register Your Request!🔹\n🔸Send `/start` To Register🔹\n🔸Hopefully u will get a reply🔹"
)

@bot.on(jungli_cmd(pattern="block$"))
...
if PM_ON_OFF != "DISABLE":
    ...
    @bot.on(jungli_cmd(pattern="(a|approve|allow)$"))
    ...
    @bot.on(jungli_cmd(pattern="(da|disapprove|disallow)$"))
    ...
    @bot.on(jungli_cmd(pattern="listapproved$"))
    async def approve_p_m(event):
        if event.fwd_from:
            return
...
CmdHelp("pm_permit").add_command(
  ...
  "listapproved", None, "Sends the list of all users approved by Jυɳɠʅι Aɾαɳƙ Bσƚ"
).add_info(
  "PM SECURITY"           
).add_warning(
  "✅ Harmless Module."
