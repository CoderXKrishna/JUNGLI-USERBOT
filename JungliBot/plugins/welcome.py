...
from JungliBot.sql.welcome_sql import get_current_welcome, add_welcome, rm_welcome, update_welcome
from . import *
...
@bot.on(jungli_cmd(pattern="savewelcome(?: |$)(.*)"))
...
@bot.on(jungli_cmd(pattern="cleanwelcome$"))
...
@bot.on(jungli_cmd(pattern="showwelcome$"))
...
@bot.on(jungli_cmd(pattern="welcome_note$"))
