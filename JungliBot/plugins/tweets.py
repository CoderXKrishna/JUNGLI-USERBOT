...
@bot.on(jungli_cmd(pattern=r"tweet(?: |$)(.*)"))
...
async def nope(kraken):
    ...
    if not jungli:
        if kraken.is_reply:
            ...
            return
    tweeter = await bot.inline_query("TwitterStatusBot", f"{(deEmojify(jungli))}")
...
@bot.on(jungli_cmd(pattern=r"trump(?: |$)(.*)"))
...
@bot.on(jungli_cmd(pattern=r"modi(?: |$)(.*)"))
...
@bot.on(jungli_cmd(pattern=r"mia(?: |$)(.*)"))
...
@bot.on(jungli_cmd(pattern=r"dani(?: |$)(.*)"))
...
@bot.on(jungli_cmd(pattern=r"pappu(?: |$)(.*)"))
...
@bot.on(jungli_cmd(pattern=r"sunny(?: |$)(.*)"))
...
@bot.on(jungli_cmd(pattern=r"johhny(?: |$)(.*)"))
...
@bot.on(jungli_cmd(pattern=r"gandhi(?: |$)(.*)"))
...
@bot.on(jungli_cmd(pattern=r"cmm(?: |$)(.*)"))
...
@bot.on(jungli_cmd(pattern=r"kanna(?: |$)(.*)"))
