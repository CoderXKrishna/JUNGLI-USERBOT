...
from . import *
from JungliBot.sql.filter_sql import get_filter, add_filter, remove_filter, get_all_filters, remove_all_filters
...
@bot.on(jungli_cmd(incoming=True))
...
@bot.on(jungli_cmd(pattern=r"filter (.*)"))
...
@bot.on(jungli_cmd(pattern="filters$"))
...
@bot.on(jungli_cmd(pattern="stop (.*)"))
...
@bot.on(jungli_cmd(pattern="rmallfilters$"))
