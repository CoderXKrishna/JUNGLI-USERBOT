...
@bot.on(jungli_cmd(pattern="frybot$"))
...
@bot.on(jungli_cmd(pattern=r"fry(?: |$)(.*)", outgoing=True))
...
async def deepfry(img: Image) -> Image:
    ...
    # Crush image to jungli and back
    img = img.convert("RGB")
    ...
    # Overlay red and yellow onto main image and sharpen the jungli out of it
