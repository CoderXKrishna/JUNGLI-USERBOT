...
@bot.on(jungli_cmd(pattern="pat ?(.*)", outgoing=True))
...
@bot.on(jungli_cmd(pattern="join$", outgoing=True))
...
@bot.on(jungli_cmd(pattern="pay$", outgoing=True))
...
@bot.on(jungli_cmd(pattern="climb$", outgoing=True))
...
@bot.on(jungli_cmd(pattern="aag$", outgoing=True))
...
@bot.on(jungli_cmd(pattern="push$", outgoing=True))
...
@bot.on(jungli_cmd(pattern="work$", outgoing=True))
...
@bot.on(jungli_cmd(pattern="suckit$", outgoing=True))
...
@bot.on(jungli_cmd(pattern="ohh$", outgoing=True))
...
@bot.on(jungli_cmd(pattern="lovestory$", outgoing=True))
...
@bot.on(jungli_cmd(pattern="bf$", outgoing=True))
...
@bot.on(jungli_cmd(pattern="session$", outgoing=True))
...
@bot.on(jungli_cmd(pattern="ftext ?(.*)"))
...
@bot.on(jungli_cmd(pattern="cat$"))
@bot.on(sudo_cmd(pattern="cat$", allow_sudo=True))
async def hmm(jungli):
    if jungli.fwd_from:
        return
    reactcat = nekos.textcat()
    await eor(jungli, reactcat)


@bot.on(jungli_cmd(pattern="why$"))
@bot.on(sudo_cmd(pattern="why$", allow_sudo=True))
async def hmm(jungli):
    if jungli.fwd_from:
        return
    whyjungli = nekos.why()
    await eor(jungli, whyjungli)


@bot.on(jungli_cmd(pattern="fact$"))
@bot.on(sudo_cmd(pattern="fact$", allow_sudo=True))
async def hmm(jungli):
    if jungli.fwd_from:
        return
    factjungli = nekos.fact()
    await eor(jungli, factjungli)
